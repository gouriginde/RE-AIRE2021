...
def getNeg(df):
    ...
    df_neg['req1'] = df['req2']
    df_neg['req1Product'] = df['req2Product']
    df_neg['req1Id'] = df['req2Id']
    
    df_neg['req2'] = df['req1']
    df_neg['req2Product'] = df['req1Product']
    df_neg['req2Id'] = df['req1Id']
...
inputFile = "../../processedGenData/Firefox_requires_Pos_Neg_Pairs.csv"
